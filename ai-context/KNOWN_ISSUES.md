...
**Дата актуализации:** 2026-09-01 (deps-refresh: MSRV 1.85, thiserror 2/axum 0.8; main-only)
...
| # | Проблема | Приоритет | Статус |
|---|---|---|---|
| 13 | **NPU sustained 83–87 °C** (30 мин непрерывного инференса; короткие прогоны давали 44 °C). Выше KPI <85 в пике | **до HITL** | Open — радиатор/обдув корпуса или троттлинг-политика (§22.2) |
