...
| 2 | **Кадры в bridge шли base64** | P1 | ✅ Fixed (D-016, M6): именованный SHM-сегмент `/dev/shm/at-infer` + round-trip тест; base64 — fallback | `shm_frame_source.cpp`, `bridge_client.rs` |
